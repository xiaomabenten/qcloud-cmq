package com.uoko.cmq;

import com.uoko.cmq.Json.JSONArray;
import com.uoko.cmq.Json.JSONObject;
...
public class Account {
    ...
    public void createSubscribe(final String topicName, final String subscriptionName, final String Endpoint, final String Protocal) throws Exception {
        createSubscribe(topicName, subscriptionName, Endpoint, Protocal, null, null, "BACKOFF_RETRY", "SIMPLIFIED");
